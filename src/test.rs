...
/* 49 */    (3, "int main() { int arr[2]; arr[0]=1; arr[1]=2; return arr[0] + arr[0+1]; }"),
/* 50 */    (5, "int main() { int x; int *p = &x; x = 5; return p[0]; }"),
/* 51 */    (1, "int main() { char x; return sizeof(x); }"),
/* 52 */    (4, "int main() { int x; return sizeof(x); }"),
/* 53 */    (8, "int main() { int *x; return sizeof x; }"),
/* 54 */    (16, "int main() { int x[4]; return sizeof x; }"),
/* 55 */    (5, "int main() { char x = 5; return x; }"),
/* 56 */    (42, "int main() { int x = 0; char *p = &x; p[0] = 42; return x; }"),
/* 57 */    (97, r#"int main() { char *p = "abc"; return p[0]; }"#),
...
/* 62 */    (0, "int x; int main() { return x; }"),
/* 63 */    (5, "int x; int main() { x = 5; return x; }"),
/* 64 */    (20, "int x[5]; int main() { return sizeof(x); }"),
/* 65 */    (15, "int x[5]; int main() { x[0] = 5; x[4] = 10; return x[0] + x[4]; }"),
/* 66 */    (0, "int main() { return 4 == 5; }"),
/* 67 */    (1, "int main() { return 5 == 5; }"),
